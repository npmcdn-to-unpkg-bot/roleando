...
var makeOneGenerator = function makeOneGenerator(str, selectors, fromContext) {
  ...
  var _loop = function _loop() {
    ...
    var pattern = _match4[0];
    var mod = _match4[1];
    var fullName = _match4[2];

    var _match5 = (fullName || '').match(/(?:([^\.]+)\.)?(.*)/);

    var _match6 = _slicedToArray(_match5, 3);

    var context = _match6[1];
    var name = _match6[2];
...
},{"./roller":5}],3:[function(require,module,exports){
'use strict';
...
},{"./generator":2,"./parser":4,"./selector":6,"marked":1}],4:[function(require,module,exports){
'use strict';
...
var parseRemoteLine = function parseRemoteLine(str) {
  ...
  var _str$match4 = _slicedToArray(_str$match3, 4);

  var name = _str$match4[1];
  var src = _str$match4[2];
  var id = _str$match4[3];

  return [id, { name: name, src: src, id: id }];
};

var matchRemoteHeader = function matchRemoteHeader(str) {
  return str.match(/^;@(usa|use|remote|tablas)/);
};
