...
"use strict";var _slicedToArray=function(){function r(r,e){var n=[],t=!0,o=!1,i=void 0;try{for(var u,a=r[Symbol.iterator]();!(t=(u=a.next()).done)&&(n.push(u.value),!e||n.length!==e);t=!0);}catch(c){o=!0,i=c}finally{try{!t&&a["return"]&&a["return"]()}finally{if(o)throw i}}return n}return function(e,n){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e))return r(e,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(r){return typeof r}:function(r){return r&&"function"==typeof Symbol&&r.constructor===Symbol?"symbol":typeof r},range=function(r){return Array.apply(null,Array(r))},generatorRE=/\[(?:([^@\]]+)@)?([^\[\]]*)\]/gm,hasMoreSelectors=function(r){return r.match(generatorRE)},dice=require("./roller"),isDiceRoll=dice.isDiceRoll,makeRoller=dice.makeRoller,getModdedGenerator=function(r,e){if(!r)return e;var n=void 0;if(n=r.match(/^x([0-9]+)/)){var t=function(){var r=range(Number(n[1])).map(function(){return function(){return e()}});return{v:function(){return r.reduce(function(r,e){return""+r+e()+" "},"")}}}();if("object"===("undefined"==typeof t?"undefined":_typeof(t)))return t.v}if(n=isDiceRoll(r)){var o=function(){var n=makeRoller(r);return{v:function(){return range(n()).map(function(){return function(){return e()}}).reduce(function(r,e){return""+r+e()+" "},"")}}}();if("object"===("undefined"==typeof o?"undefined":_typeof(o)))return o.v}if(n=r.match(/^([0-9]+)\/([0-9]+)/)){var i=function(){var r=n,t=_slicedToArray(r,3),o=t[1],i=t[2];if(!i)return{v:e};var u=makeRoller("1d"+i);return{v:function(){return u()<=o?e():""}}}();if("object"===("undefined"==typeof i?"undefined":_typeof(i)))return i.v}if(n=r.match(/^([0-9]+)%/)){var u=function(){var r=n,t=_slicedToArray(r,2),o=t[1];if(!o)return{v:""};if(o>=100)return{v:e};var i=makeRoller("1d100");return{v:function(){return i()<=o?e():""}}}();if("object"===("undefined"==typeof u?"undefined":_typeof(u)))return u.v}return e},execReplacement=function r(e,n,t){var o=e.split(/\n/);return o.reduce(function(e,o){var i=void 0;if(!hasMoreSelectors(o))return e+"\n"+o;for(;i=generatorRE.exec(o);){var u=i,a=_slicedToArray(u,3),c=a[0],f=a[1],l=a[2],d=(l||"").match(/(?:([^\.]+)\.)?(.*)/),v=_slicedToArray(d,3),y=v[1],m=v[2];y=y||t||"main";var s=void 0;if(s=isDiceRoll(m)){var p=makeRoller(m);o=o.replace(c,p())}var b=n[y+"."+m]||n[m];if(b){var R=getModdedGenerator(f,b);o=o.replace(c,R()),hasMoreSelectors(o)&&(o=r(o,n,y))}}return e+"\n"+o},"")};module.exports=function(r,e){return Object.keys(r.tpls).reduce(function(n,t){return n[t]=function(){var n=(t||"").match(/(?:([^\.]+)\.)?(.*)/),o=_slicedToArray(n,2),i=o[1];return i=i||"main",execReplacement(r.tpls[t],e,i)},n},e)};

},{"./roller":12}],8:[function(require,module,exports){
(function (process){
...
},{"./generator":7,"./parser":9,"./remotes":10,"./selector":13,"_process":5,"deep-assign":1,"isomorphic-fetch":3,"marked":4}],9:[function(require,module,exports){
...
},{"./roleando_api":11}],11:[function(require,module,exports){
(function (process){
...
},{"_process":5,"isomorphic-fetch":3}],12:[function(require,module,exports){
