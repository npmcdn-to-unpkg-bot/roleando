...
"use strict";var _slicedToArray=function(){function r(r,e){var n=[],t=!0,o=!1,u=void 0;try{for(var i,a=r[Symbol.iterator]();!(t=(i=a.next()).done)&&(n.push(i.value),!e||n.length!==e);t=!0);}catch(c){o=!0,u=c}finally{try{!t&&a["return"]&&a["return"]()}finally{if(o)throw u}}return n}return function(e,n){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e))return r(e,n);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(r){return typeof r}:function(r){return r&&"function"==typeof Symbol&&r.constructor===Symbol?"symbol":typeof r},range=function(r){return Array.apply(null,Array(r))},generatorRE=/\[(?:([^@\]]+)@)?([^\[\]]*)\]/gm,hasMoreSelectors=function(r){return r.match(generatorRE)},dice=require("./roller"),isDiceRoll=dice.isDiceRoll,makeRoller=dice.makeRoller,getModdedGenerator=function(r,e){if(!r)return e;var n=void 0;if(n=r.match(/^x([0-9]+)/)){var t=function(){var r=range(Number(n[1])).map(function(){return e()});return{v:function(){return r.reduce(function(r,e){return r+e()},"")}}}();if("object"===("undefined"==typeof t?"undefined":_typeof(t)))return t.v}if(n=isDiceRoll(r)){var o=function(){var n=makeRoller(r);return{v:function(){return range(n()).map(function(){return e()}).reduce(function(r,e){return r+e()},"")}}}();if("object"===("undefined"==typeof o?"undefined":_typeof(o)))return o.v}return e},makeOneGenerator=function r(e,n,t){for(var o=[],u=void 0,i=function(){var e=u,i=_slicedToArray(e,3),a=i[0],c=i[1],f=i[2],l=(f||"").match(/(?:([^\.]+)\.)?(.*)/),d=_slicedToArray(l,3),y=d[1],s=d[2];y=y||t||"main";var m=void 0;(m=isDiceRoll(s))&&!function(){var r=makeRoller(s);o.push(function(e){return e.replace(a,r())})}();var v=n[y+"."+s]||n[s];v&&!function(){var e=getModdedGenerator(c,v);o.push(function(t){var o=t.replace(a,e());return hasMoreSelectors(o)?r(o,n,y)():o})}()};u=generatorRE.exec(e);)i();return function(){return o.reduce(function(r,e){return e(r)},e)}},makeGenerators=function(r,e){return Object.keys(r.tpls).reduce(function(n,t){return n[t]=makeOneGenerator(r.tpls[t],e),n},{})};module.exports=makeGenerators;

},{"./roller":10}],6:[function(require,module,exports){
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),marked=require("marked"),parser=require("./parser"),createSelectors=require("./selector"),createGenerators=require("./generator"),remotes=require("./remotes"),HOST="//roleando.herokuapp.com",Generador=function(){function e(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],r=t.token,n=t.host,o=void 0===n?HOST:n;_classCallCheck(this,e),this.token=r,this.host=o,this.remotes=remotes(this.token)}return _createClass(e,[{key:"getTokenFromAuth",value:function(){var e=this;return fetch(this.host+"/auth/token",{headers:{"content-type":"application/json"},credentials:"same-origin"}).then(function(e){return e.json()}).then(function(t){return t.token?(e.setToken(t.token),t.token):Promise.reject()})}},{key:"setToken",value:function(e){this.token=e,this.remotes=remotes(this.token)}},{key:"parseString",value:function(e){var t=parser(e);return t.selectors=createSelectors(t.sources),t.generators=createGenerators(t,t.selectors),t.generate=this.generateAll.bind(t),t}},{key:"toHtml",value:function(e){return marked(e)}},{key:"generateAll",value:function(){var e=this;return Object.keys(this.generators).reduce(function(t,r){return t+" "+e.generators[r]()},"")}},{key:"listFeatured",value:function(){return this.remotes.listFeatured()}}]),e}();module.exports=Generador;

},{"./generator":5,"./parser":7,"./remotes":8,"./selector":11,"marked":2}],7:[function(require,module,exports){
"use strict";var _slicedToArray=function(){function e(e,r){var t=[],n=!0,a=!1,i=void 0;try{for(var o,u=e[Symbol.iterator]();!(n=(o=u.next()).done)&&(t.push(o.value),!r||t.length!==r);n=!0);}catch(c){a=!0,i=c}finally{try{!n&&u["return"]&&u["return"]()}finally{if(a)throw i}}return t}return function(r,t){if(Array.isArray(r))return r;if(Symbol.iterator in Object(r))return e(r,t);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),id=function(e){return e},cleanLine=function(e){return String(e).trim().replace(/\s+/," ")},comments=function(e){return!e.match(/^\/\//)},splitLines=function(e){return e.split(/\n/g).map(cleanLine).filter(id).filter(comments)},parseLine=function(e){var r=e.match(/(?:([0-9.]+),)?(.*)/),t=_slicedToArray(r,3),n=t[1],a=t[2];return n?[Number(n),cleanLine(a)]:[1,a]},parseRemoteLine=function(e){var r=e.match(/([^:]+):(.*)/),t=_slicedToArray(r,3),n=t[1],a=t[2];return[a,{name:n,id:a}]},matchRemoteHeader=function(e){return e.match(/^;@(usa|use|remotes|tablas)/)},matchTemplateHeader=function(e){return e.match(/^;@(?:tpl|plantilla)\|(.*)/)},matchTableHeader=function(e){return e.match(/^;(.*)/)};module.exports=function(e){var r=splitLines(e),t=void 0,n=void 0,a="main",i="sources";return r.reduce(function(e,r){if(t=matchRemoteHeader(r))return i="remotes",e;if(t=matchTemplateHeader(r)){var o=t,u=_slicedToArray(o,2);return a=u[1],i="tpls",e}if(t=matchTableHeader(r)){var c=t,s=_slicedToArray(c,2);return a=s[1],i="sources",e}if("remotes"!==i&&(e[i][a]=e[i][a]||[]),"sources"===i&&(n=parseLine(r),n[1]&&e[i][a].push(n)),"tpls"===i&&(e[i][a]+=r+"\n"),"remotes"===i){var l=parseRemoteLine(r);e[i][l[0]]=l[1]}return e},{sources:{},tpls:{},remotes:{}})};

},{}],8:[function(require,module,exports){
"use strict";module.exports=Object.assign(require("./roleando_api"),{join:function(t){return t.data.remotes+"\n"+t.data.tpls+"\n"+t.data.tables}});

},{"./roleando_api":9}],9:[function(require,module,exports){
(function (process){
...
},{"_process":3,"isomorphic-fetch":1}],10:[function(require,module,exports){
