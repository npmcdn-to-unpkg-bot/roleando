...
"use strict";var marked=require("marked"),parser=require("./parser"),createSelectors=require("./selector"),createGenerators=require("./generator"),remotes=require("./remotes"),convertToContent=require("./to_content"),toHtml=function(e){return marked(e)};module.exports={init:function(e){var r=parser(e);return r.selectors=createSelectors(r.sources),r.generators=createGenerators(r,r.selectors),r},remotes:remotes,convertToContent:convertToContent,toHtml:toHtml};

},{"./generator":5,"./parser":7,"./remotes":8,"./selector":11,"./to_content":12,"marked":2}],7:[function(require,module,exports){
...
(function (process){
"use strict";var fetch=require("isomorphic-fetch"),host=process.env.HOST||"//roleando.herokuapp.com",baseUrl=host+"/api/generators",toJSON=function(e){return e.json()},headers={Accept:"application/json","Content-Type":"application/json"},getHeaders=function(e){return Object.assign({Authorization:"Bearer "+e},headers)},SAVED_TOKEN=void 0,RoleandoAPI={token:null,setToken:function(e){SAVED_TOKEN=e},list:function(e){return fetch(baseUrl+"/tables",{method:"GET",credentials:"same-origin",headers:headers}).then(toJSON)},load:function(e){return fetch(baseUrl+"/table/"+e,{method:"GET",credentials:"same-origin",headers:headers}).then(toJSON)},create:function(e){return fetch(baseUrl+"/table/"+id,{method:"POST",credentials:"same-origin",body:JSON.stringify(e),headers:getHeaders(SAVED_TOKEN)}).then(toJSON)},update:function(e,t){return fetch(baseUrl+"/table/"+e,{method:"PUT",credentials:"same-origin",body:JSON.stringify(t),headers:getHeaders(SAVED_TOKEN)}).then(toJSON)},remove:function(e,t){return fetch(baseUrl+"/table/"+e,{method:"DELETE",credentials:"same-origin",headers:getHeaders(SAVED_TOKEN)}).then(toJSON)}};module.exports=RoleandoAPI;
