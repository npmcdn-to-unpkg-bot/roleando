...
var toNumber = (function (num) {
  let uno = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
...
const makeRoller = (str, filters) => {
  ...
  var _parts = slicedToArray(parts, 5);
  ...
  return () => {
    ...
    if (!op || !mod || mod === 0) {
      return convert ? toNumber(roll, convert[1]) : roll;
    }
...
var getModdedGenerator = ((mod, gen) => {
  if (!mod) {
    return gen;
  }
  ...
  if (match = mod.match(/^([0-9]+)\/([0-9]+)/)) {
    ...
    var _match2 = slicedToArray(_match, 3);

    const prob = _match2[1];
    const total = _match2[2];
  ...
  if (match = mod.match(/^([0-9]+)%/)) {
    ...
    var _match4 = slicedToArray(_match3, 2);

    const prob = _match4[1];
...
const FEMALE_PATTERNS = [[/(.)(an|on|ón|án|ór|or)(a)$/i, (_, b, c) => `${ b }${ c }`], [/(.)(et|ot)(a)$/i, (_, b, c) => `${ b }${ c }o`], [/(.)(a)$/i, (_, b) => `${ b }o`]];
...
const toName = str => toTitleCase(str).replace(nameLowerRE, (_, m) => m.toLowerCase()).replace(/((?=\S*)[a-z]|^[a-z])/i, (_, a, b) => `${ (a || '').toUpperCase() }`);
...
const addArticle = function addArticle(str) {
  let maleGeneric = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];
  return `${ isMale(str) || isGeneric(str) && maleGeneric ? 'el' : 'la' } ${ str }`;
};
const addArticleMale = str => addArticle(str, true);
const addArticleFemale = str => addArticle(str, false);

const addUndef = function addUndef(str) {
  let maleGeneric = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];
  return `${ isMale(str) || isGeneric(str) && maleGeneric ? 'un' : 'una' } ${ str }`;
};
...
const applyOuter = (str, fn) => {
  let newStr = str,
      lastIndex,
      match;
  while (match = generatorRE$1.exec(str)) {
...
var getFilteredGenerator = (strFilters => {
...
const makeInlineGenerator = str => {
  var _inlineTableRE$exec = inlineTableRE.exec(str);

  var _inlineTableRE$exec2 = slicedToArray(_inlineTableRE$exec, 3);

  const inline = _inlineTableRE$exec2[2];
...
const execReplacement = (str, selectors, fromContext, recursive) => {
  ...
  return lines.reduce((final, line) => {
    ...
    while (match = generatorRE.exec(line)) {
      ...
      var _match2 = slicedToArray(_match, 4);

      let pattern = _match2[0];
      let mod = _match2[1];
      let fullName = _match2[2];
      let filters = _match2[3];

      var _match3 = (fullName || '').match(contextRE);

      var _match4 = slicedToArray(_match3, 3);

      let context = _match4[1];
      let name = _match4[2];
...
var makeGenerators = ((data, selectors) => {
  return Object.keys(data.tpls).reduce((obj, tpl) => {
    obj[tpl] = () => {
      var _match5 = (tpl || '').match(contextRE);

      var _match6 = slicedToArray(_match5, 2);

      let context = _match6[1];
...
var createSelectors = ((tables, selectors) => {
...
const parseLine = str => {
  ...
  var _str$match2 = slicedToArray(_str$match, 3);

  const num = _str$match2[1];
  const line = _str$match2[2];
...
const parseRemoteLine = str => {
  ...
  var _str$match4 = slicedToArray(_str$match3, 3);

  const name = _str$match4[1];
  const id = _str$match4[2]; //regex with src (/([^:]+):([^:]+):(.*)/)
...
var parser = ((str, fromContext) => {
  ...
  return lines.reduce((sources, line) => {
    ...
    if (match = matchTemplateHeader(line)) {
      ...
      var _match2 = slicedToArray(_match, 2);
...
var fetchRemote = (config => id => fetch(`${ config.BASE_URL }/table/${ id }`, {
  method: 'GET',
...
var sourcesToTables = ((sources, opts) => {
...
class Generator {
  ...
  fromRemote(remoteId) {
    ...
    return fetchRemote({ BASE_URL: `${ this.host }/api/generators` })(remoteId).then(res => mergeRemote(this, res)).then(() => delete this.data.remotes[remoteId]).then(() => processSources(this));
  }
  ...
  addContent(str) {
    ...
    return promise.then(list => list.map(res => mergeRemote(this, res))).then(() => processSources(this));
  }
...
},{"deep-assign":98,"isomorphic-fetch":100}],2:[function(require,module,exports){
...
},{"core-js/library/fn/weak-map":12}],7:[function(require,module,exports){
"use strict";
...
},{"../../modules/_core":25}],9:[function(require,module,exports){
require('../modules/es6.object.to-string');
require('../modules/es6.string.iterator');
require('../modules/web.dom.iterable');
require('../modules/es6.promise');
module.exports = require('../modules/_core').Promise;
},{"../modules/_core":25,"../modules/es6.object.to-string":90,"../modules/es6.promise":91,"../modules/es6.string.iterator":92,"../modules/web.dom.iterable":97}],10:[function(require,module,exports){
require('../../modules/es6.symbol');
require('../../modules/es6.object.to-string');
require('../../modules/es7.symbol.async-iterator');
require('../../modules/es7.symbol.observable');
module.exports = require('../../modules/_core').Symbol;
},{"../../modules/_core":25,"../../modules/es6.object.to-string":90,"../../modules/es6.symbol":93,"../../modules/es7.symbol.async-iterator":95,"../../modules/es7.symbol.observable":96}],11:[function(require,module,exports){
require('../../modules/es6.string.iterator');
require('../../modules/web.dom.iterable');
module.exports = require('../../modules/_wks-ext').f('iterator');
},{"../../modules/_wks-ext":86,"../../modules/es6.string.iterator":92,"../../modules/web.dom.iterable":97}],12:[function(require,module,exports){
require('../modules/es6.object.to-string');
require('../modules/web.dom.iterable');
require('../modules/es6.weak-map');
module.exports = require('../modules/_core').WeakMap;
},{"../modules/_core":25,"../modules/es6.object.to-string":90,"../modules/es6.weak-map":94,"../modules/web.dom.iterable":97}],13:[function(require,module,exports){
...
},{"./_is-object":44}],17:[function(require,module,exports){
// false -> Array#indexOf
// true  -> Array#includes
...
},{"./_to-index":78,"./_to-iobject":80,"./_to-length":81}],18:[function(require,module,exports){
// 0 -> Array#forEach
// 1 -> Array#map
// 2 -> Array#filter
// 3 -> Array#some
...
},{"./_array-species-create":20,"./_ctx":26,"./_iobject":41,"./_to-length":81,"./_to-object":82}],19:[function(require,module,exports){
var isObject = require('./_is-object')
...
},{"./_is-array":43,"./_is-object":44,"./_wks":87}],20:[function(require,module,exports){
...
},{"./_cof":22,"./_wks":87}],22:[function(require,module,exports){
...
},{"./_an-instance":15,"./_an-object":16,"./_array-methods":18,"./_for-of":34,"./_has":36,"./_is-object":44,"./_meta":53,"./_redefine-all":68}],24:[function(require,module,exports){
'use strict';
...
},{"./_an-instance":15,"./_array-methods":18,"./_descriptors":28,"./_export":32,"./_fails":33,"./_for-of":34,"./_global":35,"./_hide":37,"./_is-object":44,"./_meta":53,"./_object-dp":57,"./_redefine-all":68,"./_set-to-string-tag":72}],25:[function(require,module,exports){
...
},{"./_a-function":13}],27:[function(require,module,exports){
...
},{"./_object-gops":62,"./_object-keys":65,"./_object-pie":66}],32:[function(require,module,exports){
var global    = require('./_global')
  , core      = require('./_core')
  , ctx       = require('./_ctx')
  , hide      = require('./_hide')
...
},{"./_an-object":16,"./_ctx":26,"./_is-array-iter":42,"./_iter-call":45,"./_to-length":81,"./core.get-iterator-method":88}],35:[function(require,module,exports){
...
},{"./_descriptors":28,"./_object-dp":57,"./_property-desc":67}],38:[function(require,module,exports){
...
},{"./_iterators":50,"./_wks":87}],43:[function(require,module,exports){
...
},{"./_hide":37,"./_object-create":56,"./_property-desc":67,"./_set-to-string-tag":72,"./_wks":87}],47:[function(require,module,exports){
'use strict';
...
},{"./_export":32,"./_has":36,"./_hide":37,"./_iter-create":46,"./_iterators":50,"./_library":52,"./_object-gpo":63,"./_redefine":69,"./_set-to-string-tag":72,"./_wks":87}],48:[function(require,module,exports){
...
},{"./_wks":87}],49:[function(require,module,exports){
...
},{"./_object-keys":65,"./_to-iobject":80}],52:[function(require,module,exports){
module.exports = true;
...
},{"./_fails":33,"./_has":36,"./_is-object":44,"./_object-dp":57,"./_uid":84}],54:[function(require,module,exports){
var global    = require('./_global')
...
},{"./_cof":22,"./_global":35,"./_task":77}],55:[function(require,module,exports){
'use strict';
...
},{"./_fails":33,"./_iobject":41,"./_object-gops":62,"./_object-keys":65,"./_object-pie":66,"./_to-object":82}],56:[function(require,module,exports){
...
},{"./_an-object":16,"./_dom-create":29,"./_enum-bug-keys":30,"./_html":38,"./_object-dps":58,"./_shared-key":73}],57:[function(require,module,exports){
var anObject       = require('./_an-object')
...
},{"./_an-object":16,"./_descriptors":28,"./_ie8-dom-define":39,"./_to-primitive":83}],58:[function(require,module,exports){
var dP       = require('./_object-dp')
  , anObject = require('./_an-object')
...
},{"./_an-object":16,"./_descriptors":28,"./_object-dp":57,"./_object-keys":65}],59:[function(require,module,exports){
...
},{"./_descriptors":28,"./_has":36,"./_ie8-dom-define":39,"./_object-pie":66,"./_property-desc":67,"./_to-iobject":80,"./_to-primitive":83}],60:[function(require,module,exports){
...
},{"./_enum-bug-keys":30,"./_object-keys-internal":64}],62:[function(require,module,exports){
...
},{"./_has":36,"./_shared-key":73,"./_to-object":82}],64:[function(require,module,exports){
var has          = require('./_has')
  , toIObject    = require('./_to-iobject')
...
},{"./_array-includes":17,"./_has":36,"./_shared-key":73,"./_to-iobject":80}],65:[function(require,module,exports){
...
},{"./_enum-bug-keys":30,"./_object-keys-internal":64}],66:[function(require,module,exports){
...
},{"./_an-object":16,"./_ctx":26,"./_is-object":44,"./_object-gopd":59}],71:[function(require,module,exports){
'use strict';
var global      = require('./_global')
  , core        = require('./_core')
...
},{"./_core":25,"./_descriptors":28,"./_global":35,"./_object-dp":57,"./_wks":87}],72:[function(require,module,exports){
...
},{"./_has":36,"./_object-dp":57,"./_wks":87}],73:[function(require,module,exports){
...
},{"./_global":35}],75:[function(require,module,exports){
...
},{"./_a-function":13,"./_an-object":16,"./_wks":87}],76:[function(require,module,exports){
...
},{"./_defined":27,"./_to-integer":79}],77:[function(require,module,exports){
var ctx                = require('./_ctx')
...
},{"./_cof":22,"./_ctx":26,"./_dom-create":29,"./_global":35,"./_html":38,"./_invoke":40}],78:[function(require,module,exports){
var toInteger = require('./_to-integer')
  , max       = Math.max
  , min       = Math.min;
...
},{"./_defined":27,"./_iobject":41}],81:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./_to-integer')
  , min       = Math.min;
module.exports = function(it){
...
},{"./_defined":27}],83:[function(require,module,exports){
...
},{"./_is-object":44}],84:[function(require,module,exports){
var id = 0
  , px = Math.random();
module.exports = function(key){
...
},{"./_core":25,"./_global":35,"./_library":52,"./_object-dp":57,"./_wks-ext":86}],86:[function(require,module,exports){
...
$exports.store = store;
},{"./_global":35,"./_shared":74,"./_uid":84}],88:[function(require,module,exports){
...
},{"./_classof":21,"./_core":25,"./_iterators":50,"./_wks":87}],89:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":14,"./_iter-define":47,"./_iter-step":49,"./_iterators":50,"./_to-iobject":80}],90:[function(require,module,exports){
...
},{"./_a-function":13,"./_an-instance":15,"./_an-object":16,"./_classof":21,"./_core":25,"./_ctx":26,"./_export":32,"./_for-of":34,"./_global":35,"./_is-object":44,"./_iter-detect":48,"./_library":52,"./_microtask":54,"./_redefine-all":68,"./_set-proto":70,"./_set-species":71,"./_set-to-string-tag":72,"./_species-constructor":75,"./_task":77,"./_wks":87}],92:[function(require,module,exports){
'use strict';
...
},{"./_iter-define":47,"./_string-at":76}],93:[function(require,module,exports){
'use strict';
...
},{"./_an-object":16,"./_descriptors":28,"./_enum-keys":31,"./_export":32,"./_fails":33,"./_global":35,"./_has":36,"./_hide":37,"./_is-array":43,"./_keyof":51,"./_library":52,"./_meta":53,"./_object-create":56,"./_object-dp":57,"./_object-gopd":59,"./_object-gopn":61,"./_object-gopn-ext":60,"./_object-gops":62,"./_object-keys":65,"./_object-pie":66,"./_property-desc":67,"./_redefine":69,"./_set-to-string-tag":72,"./_shared":74,"./_to-iobject":80,"./_to-primitive":83,"./_uid":84,"./_wks":87,"./_wks-define":85,"./_wks-ext":86}],94:[function(require,module,exports){
'use strict';
...
},{"./_array-methods":18,"./_collection":24,"./_collection-weak":23,"./_has":36,"./_is-object":44,"./_meta":53,"./_object-assign":55,"./_redefine":69}],95:[function(require,module,exports){
require('./_wks-define')('asyncIterator');
},{"./_wks-define":85}],96:[function(require,module,exports){
...
},{"./_global":35,"./_hide":37,"./_iterators":50,"./_wks":87,"./es6.array.iterator":89}],98:[function(require,module,exports){
'use strict';
...
},{"is-obj":99}],99:[function(require,module,exports){
'use strict';
...
var API_MAP = new _weakMap2.default();

var setToken = function setToken(obj) {
  return function (token) {
    return API_MAP.set(obj, { token: token });
  };
};

var getToken = function getToken(obj) {
  return function (token) {
    return API_MAP.has(obj) ? API_MAP.get(obj).token : null;
  };
};

var getTokenFromAuth = function getTokenFromAuth(obj) {
  return function () {
...
var getHeaders = function getHeaders(obj) {
  return {
    'Accept': 'application/json',
    'Content-Type': 'application/json',
...
var load = function load(obj) {
  return function (id) {
    return fetch(config.generators.BASE_URL + '/table/' + id, {
      method: 'GET',
      credentials: 'same-origin',
...
var create = function create(obj) {
  return function () {
    ...
    var generator = new RandomGenerator({ host: obj.host });
    return str ? generator.addContent(str) : _promise2.default.resolve(generator);
  };
};

var createFromRemote = function createFromRemote(obj) {
...
var getRemoteFromUrl = function getRemoteFromUrl(rawUrl) {
  ...
  return url.path.match(/\/generadores\/[^\/]+\/(.*)/) ? url.path.match(/\/generadores\/[^\/]+\/(.*)/)[1] : null;
};
...
var redirectAfter = function redirectAfter(generator) {
...
var startClipboard = function startClipboard() {
...
var UI = function UI(obj) {
  ...
  return {
    init: function init() {
      ...
      var $tableTitle = $('#generator-title');
      var $tableDesc = $('#generator-desc');
      var $btnPrint = $('#print');
      var $owned = $('#generator-owned').val();

      var SOURCE_ID = GENERATOR_SOURCE_ID || getRemoteFromUrl(window.location.href);

      var enableLoggedUI = function enableLoggedUI(data) {
        ...
        if ($owned) {
          $('#remove').removeClass('disabled').off('click').on('click', function () {
            return removeContent(SOURCE_ID);
          });
        }
      };
      ...
      var restartGenerator = function restartGenerator() {
        GENERATOR.reset();
        return GENERATOR.addContent('' + getTpls($tpls.val()) + $sources.val()).then(runGenerator);
      };
      ...
      var saveContent = function saveContent(sourceId) {
        ...
        if (id) {
          return obj.save(content).then(function (res) {
            alertOk('Guardado con exito');
          }).catch(function (err) {
        ...
        obj.save(content).then(redirectAfter).catch(function (err) {
          showError(err.message);
        });
      };

      var forkContent = function forkContent(sourceId) {
        var name = $tableName.val().trim() + ' - copia';
        var desc = $tableDesc.val().trim();
        if (!name || !desc) {
          showError('Falta nombre o descripcion');
          return;
      ...
      var removeContent = function removeContent(sourceId) {

        var removeConfirmmation = confirm('Quieres borrar este generador? Esta accion no se puede deshacer.');

        if (!removeConfirmmation) {
          return;
        }
        obj.remove(sourceId).then(function () {
      ...
      obj.auth.getTokenFromAuth().then(function (token) {
        ...
        var content = '' + getTpls($tpls.val()) + $sources.val();

        obj.create(content).then(function (gen) {
          GENERATOR = gen;
...
var index_js = Generators();

module.exports = index_js;

},{"@guumaster/rpg-generator-engine":1,"babel-runtime/core-js/json/stringify":2,"babel-runtime/core-js/promise":3,"babel-runtime/core-js/weak-map":6,"babel-runtime/helpers/typeof":7,"isomorphic-fetch":100,"marked":101}]},{},[103])(103)
});